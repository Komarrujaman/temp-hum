...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="#" @if(session('roles')==1 || session('roles')==3) {{'hidden'}} @endif class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-solid fa-plus fa-sm text-white-50"></i> Tambah Device</a>
    </div>
